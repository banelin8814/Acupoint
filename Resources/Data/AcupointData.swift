...
struct AcupointData {
    ...
    let faceAcupoints: [FaceAcupointModel] = [
        ...
        FaceAcupointModel(
            name: "攢竹穴",
            effect: "眼睛疲勞",
            method: "用中指或食指指腹,以畫圓的方式按摩20-30秒。",
            location: "位於眉毛內側凹陷處。",
            notice: """
                1.出血傾向或服用抗凝血劑者,避免力道大的按摩。
                2.局部感染發炎處,應避開按摩。
        ...
        FaceAcupointModel(
            name: "下關穴",
            effect: "耳聾、耳鳴、牙關開合不利",
            method: "用中指或食指指腹按壓30秒,同時做開闔口的動作。",
            location: "耳珠前方與下頜骨後方交界凹陷處。",
            notice: """
                1.出血傾向或服用抗凝血劑者,避免力道大的按摩。
                2.局部感染發炎處,應避開按摩。
                3.過度虛弱、空腹或無力時,避免按摩,以免反應過激。
