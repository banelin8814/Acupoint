...
//    init() {
        ...
        let faceAcupoints: [FaceAcupointModel] = [
            FaceAcupointModel(
                ...
                positionDescibition: "鼻翼外緣的中點，旁開0.5寸處的鼻唇溝陷中",
                notice: "若有疼痛，請勿按壓",
                position: [746, 311]
            ),
            FaceAcupointModel(
            ...
            FaceAcupointModel(
                ...
                positionDescibition: "位於人的眼部內側，內眼角稍上方凹陷處",
                notice: "按摩時閉眼，動作宜輕柔",
                position: [1148, 1122]
            ),
            FaceAcupointModel(
